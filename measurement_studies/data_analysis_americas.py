...
for file_name in files:
    ...
    if file_name_contents[0] == 'planetlab2.csee.usf.edu':
    ...
    elif file_name_contents[0] == 'planet-lab4.uba.ar':
        if file_name_contents[1] == '5' and file_name_contents[2] == '0':
    ...
    elif file_name_contents[0] == 'planetlab1.csuohio.edu':
        if file_name_contents[1] == '5' and file_name_contents[2] == '0':
    ...
    elif file_name_contents[0] == 'planetlab1.c3sl.ufpr.br':
        if file_name_contents[1] == '5' and file_name_contents[2] == '0':
...
#f_diff_res = open('diff_lines_americas.txt', 'w')
...
f_res = open('statistical_results_americasV2.txt', 'w')
